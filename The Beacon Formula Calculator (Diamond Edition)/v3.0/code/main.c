...
int main(void) {
    ...
    SDL_FRect INPbeta = {70, 800, twbeta, thbeta}; //Input beta box
            ...
            if (event.type == SDL_EVENT_MOUSE_BUTTON_DOWN) {
                ...
                if (mx >= CalculateBox.x && mx <= CalculateBox.x + CalculateBox.w &&
                    my >= CalculateBox.y && my <= CalculateBox.y + CalculateBox.h) {
                        ...
                        if (L == 0 || W == 0 || m == 0) {
                            printf("Error Calculation: Area does not exist!\n");
                        } else if (h_0 < 0 || L < 0 || W < 0 || m < 0 || beta < 0) {
                            printf("Error Calculating: Negative Dimentions!\n");
                        } else if (h_0 && L == 1 && W == 1 && beta > 0) {
                            printf("Error Calculating: First Beacon Formula Law revokes beta usage!\n");
                        } else {
